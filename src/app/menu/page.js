export default function MenuPage() {
    return( 
        <div>
            ...
            <div style={{display:'flex', justifyContent: 'space-between', textAlign: 'left', padding: '0 160px', marginBottom:'30 px'}}>
            ...
            <div style={{display:'flex', justifyContent: 'space-between', textAlign: 'left', padding: '0 100px', marginBottom: '200px'}}>
            ...
            <div style={{ display:'flex', justifyContent: 'space-between', textAlign: 'left', padding: '0 160px'}}>
            ...
            <h2 style={{fontSize: '30px', fontFamily: 'papyrus, charcoal, fantasy', fontWeight:'bold', textAlign:'Left', padding:'0 160px'}}>Hawaiian Style Chicken</h2>
            <div style={{display:'flex', justifyContent: 'space-between', textAlign: 'left', padding: '0 100px', marginBottom: '200px'}}>
